...
export default {
  ...
  assets: {
    ...
    'menu/index.html': {size: 5418, hash: 'bdaad90f1b42bc045a545595f1148890116a3388d5eb48f0b8c9445fa681951f', text: () => import('./assets-chunks/menu_index_html.mjs').then(m => m.default)},
